package com.weiye.sparkmall.mock.makedata

import java.text.SimpleDateFormat
import java.util.UUID

import com.weiye.sparkmall.common.model.{CityInfo, ProductInfo, UserInfo, UserVisitAction}
import com.weiye.sparkmall.common.util.ConfigurationUtil
import com.weiye.sparkmall.mock.util.{RanOpt, RandomDate, RandomNum, RandomOptions}
